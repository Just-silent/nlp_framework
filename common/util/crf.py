...
class CRF(nn.Module):
    ...
    def __init__(self, tagset_size, device):
        ...
        init_transitions[0, :] = -10000.0
        init_transitions = init_transitions.to(self._device)
    ...
    def _viterbi_decode(self, feats, mask):
        ...
        pad_zero = pad_zero.to(self._device)
        ...
        decode_idx = decode_idx.to(self._device)
    ...
    def _score_sentence(self, scores, mask, tags):
        ...
        new_tags = new_tags.to(self._device)
