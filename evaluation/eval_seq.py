...
def multilabel_confusion_matrix(y_true, y_pred, sample_weight=None,
    ...
    confusion matrix to evaluate the accuracy of a category, and output
...
def precision_recall_fscore_support(y_true, y_pred, beta=1.0, labels=None,
    ...
    If ``pos_label is None`` and in binary category, this function
    ...
    average : string, [None (default), 'binary', 'micro', 'macro', 'samples', \
        ...
        ``'samples'``:
            ...
            meaningful for multilabel category where this differs from
            :func:`accuracy_score`).
...
def _check_targets(y_true, y_pred):
    """Check that y_true and y_pred belong to the same category task
...
def classification_report(y_true, y_pred, labels=None, target_names=None,
    ...
    """Build a text report showing the main category metrics
    ...
    report : string / dict
        ...
        per label), sample average (only for multilabel category) and
        ...
        Note that in binary category, recall of the positive class
